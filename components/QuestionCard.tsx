    ...
    <div className="flex-1 flex flex-col justify-center">
      ...
      <div
        className={`grid gap-4 md:gap-6 mb-12 ${
          question.type === 'boolean' ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1 md:grid-cols-2'
        }`}
      >
        {question.allAnswers.map((answer, index) => {
          ...
          return (
            <button
              ...
              className={`group relative flex items-center p-4 md:p-6 rounded-xl border-2 text-left transition-all duration-200 disabled:cursor-not-allowed ${
                isSelected
            ...
            >
              ...
              <div
                className={`flex items-center justify-center size-10 md:size-12 rounded-lg font-bold text-lg mr-4 md:mr-6 transition-colors ${
                  isSelected

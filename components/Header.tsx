  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200 px-6 md:px-10 py-3 bg-white sticky top-0 z-50">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-gray-900 text-xl font-black leading-tight tracking-[-0.015em]">
          LuckyQuiz
        </h2>
      </div>
      ...
      <div className="flex flex-1 justify-end gap-8">
        <div className="hidden md:flex items-center gap-9">
          <Link
            className={`text-sm font-medium leading-normal transition-colors ${isActive('/home')
                ? 'text-primary'
          ...
          <Link
            className={`text-sm font-medium leading-normal transition-colors ${isActive('/leaderboard')
                ? 'text-primary'
                : 'text-gray-900 hover:text-primary'
              }`}
            href="/leaderboard"
          ...
          <Link
            className={`text-sm font-medium leading-normal transition-colors ${isActive('/history')
                ? 'text-primary'
                : 'text-gray-900 hover:text-primary'
              }`}
            href="/history"

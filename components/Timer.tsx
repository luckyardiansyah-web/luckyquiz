...
export default function Timer({ initialSeconds, onExpire }: TimerProps) {
  ...
  return (
    <div className="flex items-center gap-4 bg-surface-light dark:bg-surface-dark p-2 pr-6 rounded-full border border-gray-200 dark:border-slate-800 shadow-sm">
      <div className="relative flex items-center justify-center size-12 rounded-full bg-gray-100 dark:bg-slate-800">

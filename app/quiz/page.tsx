...
export default function QuizPage() {
  ...
  return (
    <ProtectedRoute>
      <div className="bg-[#F8F9FF] font-display text-gray-900 min-h-screen flex flex-col">
        <Header />
        ...
        <main className="flex-1 flex flex-col w-full max-w-5xl mx-auto px-6 py-8">
          ...
          <div className="flex flex-col-reverse md:flex-row md:items-center justify-between gap-6 mb-8">
            <div className="flex items-center gap-3">
              {isResumed && (
                <div className="flex items-center gap-2 pl-3 pr-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-600">
                  <span className="material-symbols-outlined text-[18px]">history</span>
                  <span className="text-sm font-bold">Resumed</span>
                </div>
              )}
              <div className="flex items-center gap-2 pl-3 pr-4 py-1.5 rounded-full bg-white border border-gray-200 shadow-sm">
